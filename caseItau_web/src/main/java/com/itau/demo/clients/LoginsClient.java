...
public class LoginsClient {
	
	private RestOperations restOperations;
	//private String bearerToken;

	
		static final String url = "http://localhost:8080/logins/";
		
		
		public LoginsClient(String accessToken ) {
		...
		public Logins getLogins(final int numero) {

			return restOperations.getForObject(url, Logins.class, numero);
		}
		
		public Logins createLogin(Logins login) {
		      ...
		      HttpEntity<Logins> requestBody = new HttpEntity<>(login, headers);
		 
		      // Send request with POST method.
		      Logins e = restTemplate.postForObject(url, requestBody, Logins.class);
